...
def figure(num=None, figsize=None, force_add=False, output_file: str = "source", placeholder: str = "", *args, **kwargs):
    ...
    if force_add or num not in _pylab_helpers.Gcf.figs.keys():
        ...
        canvas = PlotWindow(num, figsize, output_file, placeholder, *args, **kwargs).canvas
...
class PlotWindow(QtWidgets.QWidget):
    ...
    def __init__(self, number: int, size: tuple, output_file: str, placeholder: str):
    ...
    def actionSave(self):
        ...
        self.fig.change_tracker.save(self.output_file, self.placeholder)
